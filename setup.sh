...
export HULY_IMAGE_REGISTRY=${HULY_IMAGE_REGISTRY:-hardcoreeng}
export PLATFORM_REPOSITORY=${PLATFORM_REPOSITORY:-https://github.com/PrautAutomation/HulyPrautplatform.git}
export PLATFORM_REF=${PLATFORM_REF:-develop}
export TITLE=${TITLE:-Praut}
export DEFAULT_LANGUAGE=${DEFAULT_LANGUAGE:-cs}
export LAST_NAME_FIRST=${LAST_NAME_FIRST:-false}
